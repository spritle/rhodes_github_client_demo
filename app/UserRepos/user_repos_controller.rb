...
class UserReposController < Rho::RhoController
  ...
  def my_repos
    my_repo_url = "https://github.com/api/v2/json/repos/show/" + Rho::RhoConfig.username
    Rho::AsyncHttp.get(
         :url => my_repo_url,
  ...
  def watching_repos
    my_repo_url = "https://github.com/api/v2/json/repos/watched/" + Rho::RhoConfig.username
    Rho::AsyncHttp.get(
         :url => my_repo_url,
